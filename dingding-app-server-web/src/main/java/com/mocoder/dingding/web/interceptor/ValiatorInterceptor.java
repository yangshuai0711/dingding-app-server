...
import com.mocoder.dingding.common.vo.CommonRequest;
 ...
 */
public abstract class ValiatorInterceptor implements HandlerInterceptor {

    protected Logger logger = LogManager.getLogger(ValiatorInterceptor.class);
